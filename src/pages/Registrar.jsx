...
const Registrar = () => {
  ...
  const handleSubmit = async e => {
    ...
    //Crear el usuario en la API (comunicacion con el backend en node.js)
    try {
  ...
  return (
    <>
      <div>
        ...
        <div>
          <img src="/registrarCuenta.jpg" alt="Registrar cuenta" />
        </div>
      </div>
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        ...
        >
          ...
          <input type="submit" value="Registrar Usuario" className="bg-indigo-500 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto"/>
        </form>
