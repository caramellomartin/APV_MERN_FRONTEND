        ...
        >
            ...
            <div className="mb-5">
                ...
                <input 
                    id= "fecha" 
                    type="date" 
                    className="p-2 border-2 w-full mt-2 rounded-md" 
                    value={fecha} 
            ...
            <input 
                type="submit"               
                className="bg-indigo-500 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 hover:cursor-pointer transition-colors rounded-md"
